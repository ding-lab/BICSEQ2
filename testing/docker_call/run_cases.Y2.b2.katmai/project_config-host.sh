...
BICSEQ_H="/diskmnt/Projects/cptac_scratch/CPTAC3_analysis/Somatic_CNV/BICSEQ2/Y2.b2/scripts"

# Principal workflow output directory.  /data1 will map to $OUTD_H
OUTBASE_H="/diskmnt/Projects/cptac_scratch/CPTAC3_analysis/Somatic_CNV/BICSEQ2/Y2.b2/outputs"
...
DATA2="/diskmnt/Datasets/BICSEQ2/inputs"
