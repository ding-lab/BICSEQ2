...
BATCH_NAME="WGS_CNV_Somatic.Y3.UCEC.178"
...
BICSEQ_H="/storage1/fs1/dinglab/Active/Projects/CPTAC3/Analysis/WGS_CNV_Somatic/BATCH.WGS_CNV_Somatic.Y3.UCEC.178/scripts/BICSEQ2"

# Principal workflow output directory.  /data1 will map to $OUTD_H
OUTBASE_H="/storage1/fs1/dinglab/Active/Projects/CPTAC3/Analysis/WGS_CNV_Somatic/BATCH.WGS_CNV_Somatic.Y3.UCEC.178/outputs"
...
DATA4=${BICSEQ_H}"/testing/docker_call/run_cases.Y3.UCEC.178.compute1"
