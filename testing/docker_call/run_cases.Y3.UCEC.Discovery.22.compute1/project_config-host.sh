...
BICSEQ_H="/storage1/fs1/dinglab/Active/Projects/CPTAC3/Analysis/WGS_CNV_Somatic/BATCH.UCEC.Discovery.22/scripts/BICSEQ2"

# Principal workflow output directory.  /data1 will map to $OUTD_H
OUTBASE_H="/storage1/fs1/dinglab/Active/Projects/CPTAC3/Analysis/WGS_CNV_Somatic/BATCH.UCEC.Discovery.22/outputs"
...
DATA4=${BICSEQ_H}"/testing/docker_call/run_cases.Y3.UCEC.Discovery.22.compute1"
