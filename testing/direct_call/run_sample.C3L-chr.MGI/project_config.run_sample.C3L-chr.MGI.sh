...
#   data1:/gscmnt/gc2508/dinglab/mwyczalk/BICSEQ2-dev.tmp (output)  **TODO** Update for MGI
#   data2:/gscmnt/gc2521/dinglab/yigewu/Projects/CPTAC3CNV/BICSEQ2/inputs  (chrom reference (./hg38) and mappability)
#   data3:/diskmnt/Projects/cptac_downloads_3/GDC_import/data (BAM files)  **TODO** Update for MGI
